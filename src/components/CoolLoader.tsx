...
export default function CoolLoader({title, message}: CoolLoaderProps) {
    return (
        <div className="flex items-center justify-center h-screen w-full bg-slate-50 bg-gradient-to-br from-piwad-lightyellow-50 to-piwad-lightblue-200 rounded-lg border border-slate-200 p-6">
