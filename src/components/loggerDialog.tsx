                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <div className="grid grid-cols-2 gap-x-4">
                                        ...
                                        <div>
                                            <Label htmlFor="type" className="text-slate-600">Parameters</Label>
                                            <Input id={"type"} placeholder={loggerInfo.Type}
                                                onChange={(e) => setLoggerConfig({ ...loggerConfig, Type: e.target.value })} disabled />
                                        </div>
                                        <div>
                                    ...
                                    <ScrollArea className="h-[300px] w-full rounded-md border">
                                        <div className="p-4">
                                            {configLogs.length ? configLogs.map((log, index) =>(
                                                <div key={index}>
                                                    {console.log(log)}
                                                    <h4 className="text-sm font-medium">{moment(log.Timestamp).format('YYYY-MM-DD h:mm A')} - {capitalize(log.Username)}</h4>
                                                    <p className="text-sm text-muted-foreground">{capitalize(log.Parameter)} ({log.ChangedValues})</p>
